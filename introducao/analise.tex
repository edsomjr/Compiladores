...
\begin{frame}[fragile]{Exemplo de árvore gramatical}
    ...
    \begin{figure}
        ...
        \caption{Árvore gramatical do enunicado \code{cpp}{C = 1.8 * F + 32}}
    \end{figure}
...
\begin{frame}[fragile]{Análise semântica}
    ...
    \begin{itemize}
        ...
        \item Por exemplo, na expressão à direita do enunciado \code{cpp}{C = 1.8 * F + 32}, o operando à esquerda da soma tem tipo ponto flutuante e o da direita
