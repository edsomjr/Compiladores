...
\begin{frame}[fragile]{Arquivo \code{cpp}{token.h}}
    \inputcode{cpp}{codes/token.h}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{token.cpp}}
    \inputsnippet{cpp}{1}{18}{codes/token.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{token.cpp}}
    \inputsnippet{cpp}{20}{38}{codes/token.cpp}
\end{frame}
...
\begin{frame}[fragile]{Arquivo \code{cpp}{table.h}}
    \inputcode{cpp}{codes/table.h}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{table.cpp}}
    \inputsnippet{cpp}{1}{19}{codes/table.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{table.cpp}}
    \inputsnippet{cpp}{21}{39}{codes/table.cpp}
\end{frame}
...
\begin{frame}[fragile]{Arquivo \code{cpp}{scanner.h}}
    \inputcode{cpp}{codes/scanner.h}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{scanner.cpp}}
    \inputsnippet{cpp}{1}{19}{codes/scanner.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{scanner.cpp}}
    \inputsnippet{cpp}{21}{37}{codes/scanner.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{scanner.cpp}}
    \inputsnippet{cpp}{39}{57}{codes/scanner.cpp}
\end{frame}
...
\begin{frame}[fragile]{Arquivo \code{cpp}{parser.h}}
    \inputcode{cpp}{codes/parser.h}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{1}{15}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{17}{31}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{33}{50}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{52}{70}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{72}{90}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{92}{108}{codes/parser.cpp}
\end{frame}

\begin{frame}[fragile]{Arquivo \code{cpp}{parser.cpp}}
    \inputsnippet{cpp}{110}{128}{codes/parser.cpp}
\end{frame}
