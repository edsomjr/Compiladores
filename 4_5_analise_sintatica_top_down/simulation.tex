...
%        \node[anchor=west] at (11, 4) { $F\to \textbf{id}$ };
        \node[anchor=west] at (11, 4) { $T'\to \code{apl}{×}FT'$ };
    \end{tikzpicture}
...
%        \node at (2.5, 5.5) { \code{apl}{×} };
        ...
        \node[anchor=west] at (6, 4) { \textbf{id} \code{apl}{+} \textbf{id} \code{apl}{×} \textbf{id} \texttt{\$} };
        \draw[-latex,thick] (7.85, 3.2) to (7.85, 3.8);
...
%        \node at (2.5, 5.5) { \code{apl}{×} };
        ...
        \node[anchor=west] at (6, 4) { \textbf{id} \code{apl}{+} \textbf{id} \code{apl}{×} \textbf{id} \texttt{\$} };
        \draw[-latex,thick] (8.225, 3.2) to (8.225, 3.8);
...
%        \node at (2.5, 5.5) { \code{apl}{×} };
        ...
        \node[anchor=west] at (11, 4) { $E'\to  \code{apl}{∊}$ };
%        \node[anchor=west] at (11, 4) { $T'\to \code{apl}{×}FT'$ };
    \end{tikzpicture}
