...
\begin{frame}[fragile]{Diagrama de transição para operadores relacionais}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture} 
            ...
            \node[anchor=west] at (9.5, 4) { \footnotesize \texttt{retorne \{ $\mathbf{relop}$, NT\ \}} };
...
\begin{frame}[fragile]{Identificadores e palavras-chave}
    ...
    \begin{itemize}
        ...
        \item A função $inserirToken(s)$ insere o lexema $s$ na tabela de símbolos como um token \textbf{id}, caso $s$ não esteja presente na tabela; caso
...
\begin{frame}[fragile]{Diagrama de transição para identificadores e palavras-chave}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture} 
            ...
            \node[anchor=west] at (9.75, 6) { \footnotesize \texttt{retorne \{ $inserirToken(s)$ \} } };
