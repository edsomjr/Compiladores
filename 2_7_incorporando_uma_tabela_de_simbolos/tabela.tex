...
\begin{frame}[fragile]{A análise léxica e a tabela de símbolos}
    ...
    \begin{itemize}
       ...
       %\pause
        ...
        \item A rotina \Call{buscar}{$s$} regasta o token associado ao lexema $s$, permitindo a consulta (e, se necessário, atualização) deste token
       %\pause
    ...
    \begin{algorithmic}[1]
        ...
        \Loop
            ...
            \ElsIf{$c$ é uma letra}
                ...
                \EndIf
                \State{\Return{ \Call{buscar}{$lexema$}} }
            \Else
